"""
This file (converting Python functions into OpenAI tool definitions) was sourced from:
https://github.com/aurelio-labs/funkagent/blob/main/funkagent/parser.py

Original source: funkagent by Aurelio Labs
